...
function Cart() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-[#F9F9F9] px-10 py-20 pt-40">
      <h3 className="hidden px-10 pb-10 pt-10 text-center text-4xl font-bold md:inline-block">
        Order list
      </h3>
      {!isCheckingOut && (
        <div className="flex w-[600px] max-w-[300px] flex-col items-center justify-center rounded-2xl bg-red-100 p-4 md:h-[500px] md:max-h-[500px] md:max-w-[600px] md:flex-row md:gap-10 md:p-10">
          ...
          <div className="flex h-[500px] w-full flex-col overflow-y-scroll rounded-lg bg-[#F5F5F5] px-6 py-2 md:h-full md:overflow-x-hidden md:overflow-y-scroll">
            {data &&
              data.map((data, i) => (
