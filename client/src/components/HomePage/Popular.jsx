...
function Popular() {
  return (
    <div className="bg-[#E7F7ED] flex flex-col items-center md:flex-row gap-2 lg:gap-10 xl:gap-20 justify-center py-20 px-10">
      <div>
        <img
      ...
      <div className="flex flex-col items-center md:items-start">
        ...
        <p className="text-[#5C4429] max-w-[370px] leading-8 mt-6 text-lg text-center md:text-start">
        ...
        <button className="text-white px-10 font-semibold text-lg w-full md:w-fit bg-red-500 py-3 rounded-xl mt-8">
          Order now
        </button>
      </div>
    </div>
